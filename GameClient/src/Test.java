...
/*
class Test_frame extends JFrame implements Runnable, KeyListener{
	boolean keyUp = false;
	...
	Image img;
	Image img_up = new ImageIcon(GamePlayer.class.getResource("/assets/player/bazzi/up.png")).getImage();
	Image img_down = new ImageIcon(GamePlayer.class.getResource("/assets/player/bazzi/down.png")).getImage();
	Image img_left = new ImageIcon(GamePlayer.class.getResource("/assets/player/bazzi/left.png")).getImage();
	Image img_right = new ImageIcon(GamePlayer.class.getResource("/assets/player/bazzi/right.png")).getImage();
	...
	if ( cnt / 10 % 6 == 0 ){ gc.drawImage(img,
	x - ( width * 0 ), y, this);

	}else  if(cnt/10%6 == 1){ gc.drawImage(img,
	x - ( width * 1 ), y, this);

	}else  if(cnt/10%6 == 2){  gc.drawImage(img,
			x - ( width * 2 ), y, this);

	}else  if(cnt/10%6 == 3){ gc.drawImage(img,
			x - ( width * 3 ), y, this);
	}else  if(cnt/10%6 == 4){ gc.drawImage(img,
		x - ( width * 4 ), y, this);
	}
	else  if(cnt/10%6 == 5){ gc.drawImage(img,
		x - ( width * 5 ), y, this);
	}
	...
	}else { gc.drawImage(img, x - ( width * 0 ), 
	y, this);
